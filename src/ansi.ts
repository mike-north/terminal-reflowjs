...
/**
 * Alias for ANSI_MARKER for compatibility with indent module
 * @public
 */
...
/**
 * Alias for isAnsiTerminator for compatibility with indent module
 * @public
 */
...
/**
 * Writer class for compatibility with indent module.
 * This provides the interface expected by indent module from main.
 * Reference: https://github.com/muesli/reflow/blob/master/ansi/writer.go
 * @public
 */
export class Writer {
